...
echo "desktop tray tools.."
sudo apt-get install -q redshift-gtk geoclue-2.0 >>setup.log 2>&1
sudo apt-get install -q clipit tilda autokey-gtk variety transmission >>setup.log 2>&1
